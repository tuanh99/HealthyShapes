    ...
    <div class="bg0 m-t-23 p-b-140 p-t-80">
        <div class="container">
            <div class="flex-w flex-sb-m p-b-52">
             ...
             <!-- chat -->
                <!-- <div class="dis-none panel-search w-full p-t-10 p-b-15">
                <form action="{{ route('products.index') }}" method="GET" class="bor8 dis-flex p-l-15">
                    <button class="size-113 flex-c-m fs-16 cl2 hov-cl1 trans-04">
                        <i class="zmdi zmdi-search"></i>
                    </button> -->

                    <!-- Trường nhập từ khóa tìm kiếm -->
                    <!-- <input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search" placeholder="Search" value="{{ request()->query('search') }}">
                </form>
            </div> -->
...
<!-- chat -->
        ...
        <!-- <div class="row">
            @if($products->count())
                ...
                @endforeach
            @else
                <p>Không tìm thấy sản phẩm nào khớp với từ khóa tìm kiếm.</p>
            @endif
        </div> -->
